...
하고 있습니다.
  * **고급 Ops 엔지니어링**: ArgoCD 기반의 GitOps 환경을 구축하고, Kafka를
활용한 이벤트 중심 아키텍처(EDA)를 연구하며 데이터 흐름의 주도권을 잡고
있습니다.
...
* **[Cloud-Native Infrastructure](https://github.com/buenhyden/hy-home.docker)**: PostgreSQL HA, Kafka, LLM이 통합된 Docker 기반 홈 서버 인프라입니다.
